...
* [0.60.2](https://hub.docker.com/r/11notes/medikeep/tags?name=0.60.2)
...
# REGISTRIES ☁️
```
docker pull 11notes/medikeep:0.60.2
docker pull ghcr.io/11notes/medikeep:0.60.2
docker pull quay.io/11notes/medikeep:0.60.2
```
...
*created 30.03.2026, 09:01:50 (CET)*